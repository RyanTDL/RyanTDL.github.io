...
const About = () => {
    return (
        <div id="about" className="overflow-hidden container mx-auto px-8 py-10 md:py-10 lg:py-10 flex flex-col gap-4 lg:gap-8">
            <p className="font-bold text-4xl lg:text-5xl text-center">Introducing Me</p>
            <div className="flex flex-col items-center md:flex-row lg:flex-row gap-14">
